console.log('jcell :: lab.js')  

// shadowRoot.innerHTML=document.getElementById('htmlForShadow').textContent
    const canvas = stemdiv.shadowRoot.getElementById('simCanvas');
    const ctx = canvas.getContext('2d');
        // Control Elements
    const massSlider = stemdiv.shadowRoot.getElementById('massSlider');
    const massText = stemdiv.shadowRoot.getElementById('massText');
    const stiffnessSlider = stemdiv.shadowRoot.getElementById('stiffnessSlider');
    const stiffnessText = stemdiv.shadowRoot.getElementById('stiffnessText');
    const startStopBtn = stemdiv.shadowRoot.getElementById('startStopBtn');
    const msgbox = stemdiv.shadowRoot.getElementById('msgbox')
